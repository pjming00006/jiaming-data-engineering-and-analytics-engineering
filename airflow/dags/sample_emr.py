...
# Replace this with your JAR path
JAR_S3_PATH = f"s3://{Variable.get("de_etl_bucket")}/emr_packages/spark-scala-assembly-0.1.0.jar"
    ...
    "Steps": [
        {
            ...
            "HadoopJarStep": {
                ...
                "Args": [
                    "spark-submit",
                    "--deploy-mode", "cluster",
                    "--class", "HelloSpark", # It's required to specify an entrypoint
                    JAR_S3_PATH
                ],
            },
        }
